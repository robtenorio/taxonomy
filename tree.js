...
var totalNodes = 0;
    ...
    d3.json(`taxonomy_data/${country}_taxonomy.json`, (treeData) => {
        ...
        function update(source) {
          ...
          // Normalize for fixed-depth. set first node to 100
          nodes.forEach(function(d){ d.y = d.depth == 0 ? 100 : d.depth * 250});
